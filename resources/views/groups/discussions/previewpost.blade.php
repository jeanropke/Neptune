<table border="0" cellpadding="0" cellspacing="0" width="100%" class="group-postlist-list" id="group-postlist-list">
    <tr class="post-list-index-even" id="new-post-preview">
            ...
            <tbody>
                <tr>
                    <td class="post-header-link">
                        <div class="topiclist-row-content">RE: {{ $topic->subject }}<br><span class="topiclist-lastpost-time">{{ $post->created_at->format('j.n.Y H:i:s') }}</span>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td valign="top">
                        ...
                        <div class="post-list-content-element">
                            {!! bb_format($post->message) !!}
                            <input type="hidden" id="post-message-hidden" value="{{ $post->message }}">
                        </div>
                    </td>
                </tr>
                <tr>
