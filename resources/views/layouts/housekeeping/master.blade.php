...
<head>
    ...
    <script src="/web/admin/js/scripts.js"></script>
    <script src="/web/admin/js/jquery-3.5.1.min.js"></script>
    <script>
    ...
    <link rel="icon" href="{{ url('/') }}/web/admin/images/favicon.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{ url('/') }}/web/admin/images/favicon.png" type="image/x-icon">
</head>
    ...
    <div id="loading-layer" style="display:none">
        <div id="loading-layer-shadow">
            <div id="loading-layer-inner">
                <img src="{{ url('/') }}/web/admin/images/loading_anim.gif" style="vertical-align:middle" border="0"
                    alt="Loading..." />
                <br />
