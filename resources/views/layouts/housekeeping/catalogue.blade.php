<div class="menuouterwrap">
    <div class="menucatwrap"><img src="{{ cms_config('site.web.url') }}/admin/images/menu_title_bullet.gif"
            style="vertical-align:bottom" border="0" /> Catalogue Configuration</div>

    <div class="menulinkwrap">&nbsp;
        <img src="{{ cms_config('site.web.url') }}/admin/images/item_bullet.gif" border="0" alt="" valign="absmiddle">&nbsp;
