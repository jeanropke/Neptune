                                    ...
                                    <div class="v3box green">
                                        ...
                                        <div class="v3box-content">
                                            <div class="v3box-body">
                                                ...
                                                <br><br>See all <a href="{{ url('/') }}/games/battleball/high_scores" target="_self">High Scores</a><br>
                                                Read about <a href="{{ url('/') }}/games/battleball/challenge" target="_self">The Challenge</a>
                                                <div class="clear"></div>
                                            </div>
                                        </div>
