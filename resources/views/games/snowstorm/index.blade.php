                                    ...
                                    <div class="portlet-scale gold">
                                        ...
                                        <div class="portlet-scale-body">
                                            <div class="portlet-scale-content">
                                                ...
                                                <div align="center"><img src="{{ url('/') }}/c_images/album1618/Snowstorm_LandingP_505x236.gif" alt="">
                                                </div>

                                                <p><img hspace="5" align="right" src="{{ url('/') }}/c_images/album1478/ss_button_level_003.gif" alt="">Welcome to
                                                    Snowstorm, the latest and greatest online multiplayer game to hit Habbo. Using strategy, teamwork, and
                                                ...
                                                <p><img hspace="5" align="left" src="{{ url('/') }}/c_images/album1478/ss_button_level_004.gif" alt=""><a
                                                        href="{{ url('/') }}/games/snowstorm/rules">Learn how to
                                                        play SnowStorm!</a></p>
                                                <div class="clear"></div>
                                            </div>
                                        </div>
