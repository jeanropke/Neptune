...
<table cellpadding="0" cellspacing="8" width="100%" id="tablewrap">
    <tr>
        <td width="22%" valign="top" id="leftblock">
            <div>
                @include('layouts.admin.site', ['submenu' => 'news_compose'])
            </div>
        </td>
        <td width="78%" valign="top" id="rightblock">
            <div>
                ...
                @endif
                <form action="{{ route('admin.site.news_compose') }}" method="post" name="theAdminForm"
                                ...
                                <td class="tablerow2" width="60%" valign="middle">
                                    ...
                                    <select name="topstory" onchange="changePreviewImage()" id="ts_image"
                                        ...
                                        <option value="{{ url('/') }}/{{ str_replace('\\', '/', $ts_img) }}"
                                            @if(url('/') .'/'. str_replace('\\', '/' , $ts_img)==old('topstory'))
                                            selected="selected" @endif>{{ explode('/', $ts_img)[3] }}</option>
                                        @endforeach
                                    </select>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tablerow2" width="60%" valign="middle">
                                    <textarea name="short_story" cols="60" rows="5" wrap="soft" id="sub_desc"
                                        class="multitext">{{ old('short_story') }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tablerow2" width="60%" valign="middle">
                                    <textarea name="story" cols="60" rows="5" wrap="soft" id="article"
                                        class="multitext">{{ old('story') }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td class="tablerow2" width="60%" valign="middle">
                                    <input type="text" name="author" value="{{ Auth::user()->username }}" size="30"
                                        class="textinput">
                                </td>
                            </tr>
                            <tr>
