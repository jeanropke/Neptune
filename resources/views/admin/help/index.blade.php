@extends('layouts.admin.master', ['menu' => 'help'])
...
<table cellpadding="0" cellspacing="8" width="100%" id="tablewrap">
    <tr>
        <td width="22%" valign="top" id="leftblock">
            <div>
                @include('layouts.admin.help', ['submenu' => 'help'])
            </div>
        </td>
                    ...
                    <div class="homepage_pane_border" id="acp-update-normal">
                        ...
                        <div style="font-size:12px;padding:4px; text-align:left">
                            <p>
                                ...
                                other topics we thought could be usefull whilst using and setting up HoloCMS and it's
                                housekeeping.
                                <br />
                                <br />Should, however, the Help Centre not supply enough information and/or support, you
                                can always ask your question on <a href="http://forum.ragezone.com/f282"
                                    target="_blank">RaGEZONE</a> -- that's where the experts on this subject hang out
