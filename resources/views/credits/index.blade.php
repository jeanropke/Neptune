                                        ...
                                        <div class="v2box brown darkest">
                                            ...
                                            <div class="body">
                                                ...
                                                <div class="purse-balance">
                                                    You has <span class="purse-balance-amount">&nbsp;<span
                                                            class="habbocredits">{{ Auth::user()->credits }}</span>&nbsp;</span>
                                                ...
                                                <div id="purse-redeem">
                                                    ...
                                                    <div id="purse-form-container">
                                                        If you have a Credit or furniture redemption code, enter it
                                                        below
                                                        <form method="post" action="{{ url('/') }}/credits/redeem"
                                                            id="purse-redeem-form">
                                                            <input type="text" name="redeem-code" size="35"
                                                                id="redeem-code" />
                                                            <a href="" class="colorlink orange last"
                                                                align="top"><span>Redeem</span></a>
                                                        </form>
                                                    </div>
                                                    @else
                                                    <div>
                                ...
                                <div class="v3box green">
                                    ...
                                    <div class="v3box-content">
                                        <div class="v3box-body">
                                            ...
                                            <img width="110" height="103" border="0" align="right"
                                            ...
                                            <ul>
                                                <li>decorate your room
                                                    with <a href="{{ url('/') }}/hotel/furniture"
                                                        target="_self">{{ cms_config('hotel.name.short') }}
                                                        Furni</a></li>
                                            ...
                                            to buy {{ cms_config('hotel.name.short') }} Coins. Take a look at the list to the left.<span
                                                style="font-weight: bold;"><br><br>Please note</span>, {{ cms_config('hotel.name.short') }}
                                            Coins have
