...
@section('content')
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="content-2col">
        ...
        <tr>
            ...
            @include('includes.furniture', ['page' => 'decoration_examples', 'menu' => 'catalogue'])
            <td valign="top" style="width: 539px;" class="habboPage-col rightmost">

                <div class="v3box yellow">
                    <div class="v3box-top"><h3>Decoration Examples</h3></div>
                    <div class="v3box-content">
                        <div class="v3box-body">

                            <img width="99" height="118" border="0" align="right" id="galleryImage"
                                 src="{{ url('/') }}/web/images/credits/choice_newsie.gif"
                                 alt="">The possibilities are endless with {{ cms_config('hotel.name.short') }} Furni: You can make a rare room, a
                            ...
                            <table width="100%" border="0">
                                <tbody>
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         id="galleryImage" alt="thumb kick"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_kick.gif">
                                        </p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Kick
                                            ...
                                            screens and bars and make sure you're the last user standing!<br></p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         id="galleryImage" alt="thumb pacman"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_pacman.gif">
                                        </p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Pacman</b><br>A
                                            late {{ cms_config('hotel.name.short') }} classic: Developed in 2004 by a {{ cms_config('hotel.name.short') }} who was later banned for
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         id="galleryImage" alt="thumb fridge"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_fridge.gif">
                                        </p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Fridge Races<br></b>A
                                            ...
                                            right object, and then dash back to the seats!</p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         align="left" id="galleryImage7"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_maze.gif"
                                                                         alt=""></p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"></p>
                                        ...
                                        <p align="left" style="margin-top: 0pt; margin-bottom: 0pt;">There are two main
                                            ...
                                            for a winner to emerge!<br></p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         id="galleryImage" alt="thumb theatre"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_theatre.gif">
                                        </p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Theatres</b><br>Put
                                            ...
                                            audience with the middle of the room working as a stage!<br></p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         align="left" id="galleryImage"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_discussionroom.gif"
                                                                         alt=""></p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><br><b>Discussion
                            ...
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         align="left" id="galleryImage8"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_restaurant2.gif"
                                                                         alt=""></p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><strong>Restaurants<br></strong>A
                                            ...
                                            touch of elegance and romance.<br></p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         align="left" id="galleryImage9"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_helpcentre.gif"
                                                                         alt=""></p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;"><b>Helpdesks</b>
                                        </p>
                                        ...
                                        <p align="left" style="margin-top: 0pt; margin-bottom: 0pt;">Want to help your
                                            ...
                                            questions. It's almost as much fun as it sounds!</p></td>
                                </tr>
                                </tbody>
                            </table>
                            <table width="100%" border="0">
                                ...
                                <tr>
                                    <td width="216"><p align="left"><img width="186" height="126" border="0"
                                                                         align="left" id="galleryImage10"
                                                                         src="{{ url('/') }}/web/images/credits/thumb_greatwallofchina.gif"
                                                                         alt=""></p></td>
                                    <td><p align="left" style="margin-top: 0pt; margin-bottom: 0pt;">
                                            <br><b>Monuments</b></p>
                                        ...
                                        <p align="left" style="margin-top: 0pt; margin-bottom: 0pt;">Show off your
                                            ...
                                            scratch their chins in disbelief...</p></td>
                                </tr>
                                </tbody>
                            </table>
                            <p></p>
