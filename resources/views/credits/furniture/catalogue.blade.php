                        ...
                        <tbody>
                            <tr>
                                <td valign="top" style="width: 208px; height: 400px;" class="habboPage-col">
                                    @include('credits.furniture.include.menu', ['page' => 'catalogue'])
                                    @foreach (boxes('credits.furniture.catalogue', 1) as $box)
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td width="1068"><strong>Presents<br></strong>Show your {{ cms_config('hotel.name.short') }} friends just how much
                                                                ...
                                                                Catalogue item can be sent as a gift to any {{ cms_config('hotel.name.short') }}- all you need is their
