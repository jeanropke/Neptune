                    ...
                    <div class="v3box yellow">
                        ...
                        <div class="v3box-content">
                            <div class="v3box-body">
                                ...
                                <img width="35" height="40" border="0" align="right" id="galleryImage" src="{{ url('/') }}/c_images/album1774/croc16.png"
                                ...
                                bowl and you’ll have an unlimited supply of water for your pet. Double-click<img hspace="0" border="0" align="right"
                                    src="{{ url('/') }}/c_images/album129/Cat_burglar_small.gif" alt=""> on the bowl to re-fill it at any time. <br><br>Keep your pet
                                playful and lively
                                ...
                                and trying to catch your attention. <br><br><img width="66" height="39" border="0" align="right" id="galleryImage"
                                    src="{{ url('/') }}/c_images/album02/pet_info_pic10.gif" alt=""> Your pet will need a nap every now and then. It gets more tired when
                                it's active
                                ...
                                <br><br><strong>Commands anyone can use are:</strong><br><img width="38" height="33" border="0" align="right" id="galleryImage"
                                    src="{{ url('/') }}/c_images/album129/Joe_cocker_spaniel_small.gif" alt=""><br>Sit: Makes the pet sit down <br>Lie down: Gets the pet
                                to lie down <br>Jump:
                                ...
                                you <br>Beg: The pet will beg for a reward from you <img hspace="0" border="0" align="right"
                                    src="{{ url('/') }}/c_images/album129/pixie_poodle_small.gif" alt=""><br>Go away: Your pet will move away from you <br>Bad: Tells your
                                pet off
