                                        ...
                                        <div class="v3box-content">
                                            <div class="v3box-body">
                                                ...
                                                <p><strong>Trophies</strong><br><img width="44" height="108" border="0" align="right"
                                                        src="{{ cms_config('site.web.url') }}/images/credits/trophy_17.gif" id="galleryImage" alt="">Reward your
                                                ...
                                                <p><br><strong>Holodice</strong><br><img width="51" height="65" border="0" align="right"
                                                        src="{{ cms_config('site.web.url') }}/images/credits/holodice.gif" id="galleryImage" alt="">Holodice are great fun to
                                                    ...
                                                    higher or lower than the previous.<br><br><strong>Hatches</strong><br><img width="49" height="55" border="0"
                                                        align="right" src="{{ cms_config('site.web.url') }}/images/credits/iced_item_8.gif" id="galleryImage" alt="">Hatches
                                                    ...
                                                    closes it.<br><br><strong>Alerts</strong><br><img width="49" height="55" border="0" align="right"
                                                        src="{{ cms_config('site.web.url') }}/images/credits/lert.gif" id="galleryImage" alt="">
                                                    ...
                                                    Click on the top of the Furni to make set off the alert!<br><br><strong>Rollers</strong><br><img width="64" height="40"
                                                        border="0" align="right" src="{{ cms_config('site.web.url') }}/images/credits/roller_aqua.gif" id="galleryImage"
                                                    ...
                                                    them!)- place them next to a valuable porter and watch the players fall over themselves!<br><br><strong>Stickies</strong><br><img
                                                        width="37" height="33" border="0" align="right" src="{{ cms_config('site.web.url') }}/images/credits/Stickies.png"
