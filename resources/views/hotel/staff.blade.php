@extends('layouts.master', ['menuId' => '2', 'submenuId' => '12', 'headline' => true])
                                    ...
                                    <tr class="{{ $loop->index % 2 ? 'even' : 'odd'}}">
                                        <td class="style1">
                                            <p style="height: 64px; overflow: hidden;"><b>
                                                    <img width="64" hspace="5" height="110" align="right"
                                                    ...
                                                    href="{{ url('/') }}/home/{{ $staff->username }}"
                                                    target="_blank">{{ $staff->username }}</a> ~ <img
