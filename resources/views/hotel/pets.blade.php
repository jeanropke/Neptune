                    ...
                    <div class="v3box yellow">
                        ...
                        <div class="v3box-content">
                            <div class="v3box-body">
                                ...
                                <img vspace="0" hspace="7" border="0" src="{{ url('/') }}/c_images/album1702/pets200.gif" alt=""><br><br>
                                <center><span style="font-style: italic;"><span style="font-weight: bold;"></span><br><span style="font-style: italic;"><br></span></span></center>
                                <p><img vspace="0" hspace="7" border="0" align="right" src="{{ url('/') }}/c_images/album129/Paws_forethought.gif"
                                        alt="">Every home
                                    ...
                                    happy.</p>
                                <p><img vspace="0" hspace="8" border="0" align="left" src="{{ url('/') }}/c_images/album1702/croc300percent.gif" alt=""><span
                                        ...
                                        pet down in one of your own rooms. You can own several pets but only <span style="font-weight: bold;">three </span>are allowed in the same room
                                        at the same
                                ...
                                <p><img width="194" hspace="6" height="87" border="0" align="left" id="galleryImage"
                                        src="{{ url('/') }}/c_images/album209/pet_info_pic2_UK.gif" alt=""><strong>Age</strong>: One day of real time is equal to one pet
                                    year
                                    ...
                                    <br><strong>Nature</strong>: Unique for each pet.
                                </p>
