@extends('layouts.master', ['menuId' => '2', 'submenuId' => 'web', 'headline' => true])
        ...
        <tbody><tr>
            ...
            <td valign="top" style="width: 539px;" class="habboPage-col rightmost">
                ...
                <div class="v3box blue">
                    <div class="v3box-top"><h3>Things You Can Do On The Website</h3></div>
                    <div class="v3box-content">
                        <div class="v3box-body">
                            ...
                            <table width="100%" border="0" id="table1">
                                <tbody><tr>
                                    <td valign="top">
                                        <img src="{{ url('/') }}/web/images/hotel/Habbo_Welcome_Instructions_Web_Registering.gif"> </td>
                                    <td valign="top"><b>Logging in<br></b>
                                        <p>To log into {{ cms_config('hotel.name.short') }} click the Sign In button under the My {{ cms_config('hotel.name.short') }}
                                            ...
                                            register button to enter into our baffling registration process.</p><p>Once you have logged in you can change your profile, buy Furni from our site, see your <a href="{{ url('/') }}/home" target="_self">{{ cms_config('hotel.name.short') }} Homes</a> page and more!<br></p></td>
                                </tr>
                                </tbody></table><p>
                            </p><table width="100%" border="0" id="table2">
                                <tbody><tr>
                                    <td valign="top">
                                        <img src="{{ url('/') }}/web/images/hotel/Habbo_Welcome_Instructions_Toolbar_Profile.gif"> </td>
                                    <td valign="top"><b>{{ cms_config('hotel.name.short') }} Profiles<br></b>
                                        <p>Once you have logged in you can edit your profile by clicking on
                                            ...
                                            in case you registered  under 'hitmail' or 'ghfdhdsiuh@hniudsjidsj.com and your password.</p><p>
                                            Detailed, and witty, instructions on how to change your password or
                                            email address can be found under your profile also.</p></td>
                                </tr>
                                </tbody></table><p></p><p>&nbsp;</p><p></p><p>
                            </p><table width="100%" border="0" id="table4">
                                <tbody><tr>
                                    <td valign="top">
                                        <img src="{{ url('/') }}/web/images/hotel/Habbo_Welcome_Instructions_Toolbar_Purse.gif"> </td>
                                    <td valign="top"><b>{{ cms_config('hotel.name.short') }} Purse<br></b>
                                        <p>Also on the {{ cms_config('hotel.name.short') }} Toolbar is the My Credits tab that allow you to see
                                            how many {{ cms_config('hotel.name.short') }} Credits you have and link to the {{ cms_config('hotel.name.short') }} Credits page and
                                ...
                                <tbody><tr>
                                    <td valign="top"><img src="{{ url('/') }}/web/images/hotel/Habbo_Welcome_Instructions_Navigator_Widget.gif" alt=""><br> </td>
                                    <td valign="top"><b>Direct Room Links<br></b><p>With the new website you can
                                        ...
                                        <p><a href="{{ url('/') }}/hotel/welcome_to_habbo_hotel/how_to_get_started" target="_self">More about {{ cms_config('hotel.name.full') }}</a></p></td>
                                </tr>
                                </tbody></table><p></p><p>
                            </p><table width="100%" border="0" id="table6">
                                <tbody><tr>
                                    <td valign="top">
                                        <img src="{{ url('/') }}/web/images/hotel/Habbo_Welcome_Instructions_Web_Buying.gif"> </td>
                                    <td valign="top"><span style="font-weight: 700;">Buying {{ cms_config('hotel.name.short') }} Furni from
		website</span><span style="font-weight: bold;"><br></span><p>Another
                                        ...
                                        <p><a href="{{ url('/') }}/credits/furniture/" target="_self">More about {{ cms_config('hotel.name.short') }} Furni</a></p></td>
                                </tr>
                                </tbody></table><p></p>
                            <div class="clear"></div>
                        </div>
