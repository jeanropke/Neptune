                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" colspan="2"><img vspace="15" hspace="4" border="0"
                                                                    src="{{ url('/') }}/c_images/album1895/tm_room_latingroove_2.gif" alt=""></td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" rowspan="2"><br><img vspace="5" hspace="5" border="0" align="left"
                                                                    src="{{ url('/') }}/c_images/album1395/flamenco_2.gif" alt="">Latin American music, sometimes simply
                                                                called Latin music, includes
                                                            ...
                                                            <td bgcolor="#c0c0c0">
                                                                <p align="center"><a href="{{ url('/') }}/c_images/album949/reggae_trax.gif">
                                                                        <img"><img src="{{ url('/') }}/c_images/album1390/reggae_200x131.gif" alt=""></img">
                                                                    </a></p>
                                                                <p align="center"><a href="{{ url('/') }}/c_images/album949/reggae_trax.gif">Click
                                                            ...
                                                            <td bgcolor="#c0c0c0">
                                                                <p style="margin-left: 10px;"><span style="font-weight: bold;">Trax used in this composition:<br>
                                                                    ...
                                                                    Little Tanga Beach<br> <img vspace="0" hspace="0" border="0" align="bottom"
                                                                        src="{{ url('/') }}/c_images/album2304/trax_bullet_blue.gif" alt=""> Bhangra Mangra<br> <img
                                                                        vspace="0" hspace="0" border="0" align="bottom"
                                                                        src="{{ url('/') }}/c_images/album2304/trax_bullet_green.gif" alt=""> Jive Sideburns<span
                                                                        style="font-weight: bold;"></span></p>
                                                                <p style="margin-left: 10px;">
                                                                    <br><br> Listen now <a href="{{ url('/') }}/c_images/album2354/traxexample8_oriental.mp3"><img vspace="0"
