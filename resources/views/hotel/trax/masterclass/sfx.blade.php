                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td align="center" colspan="2">
                                                                <img vspace="15" hspace="4" border="0"
                                                                    src="{{ url('/') }}/c_images/album1895/tm_room_horror_2.gif"
                                                                    alt=""><br>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" rowspan="2"><br><img vspace="5" hspace="5" border="0" align="left"
                                                                    src="{{ url('/') }}/c_images/album1395/dj_sounddesign.gif"
                                                                    alt="">The term 'sound design' comes originally from the world of theatre and was
                                                            ...
                                                            <td valign="top" bgcolor="#c0c0c0">
                                                                <p align="center">
                                                                    <align="center">&nbsp;</align="center"><br><a
                                                                        href="{{ url('/') }}/c_images/album949/sounddesign1_trax.gif">
                                                                        <img"><img border="0"
                                                                                src="{{ url('/') }}/c_images/album1390/sounddesign_2_200x131.gif"
                                                                                alt=""><br></img">
                                                                    </a></p>
                                                                <p align="center"><a
                                                                        href="{{ url('/') }}/c_images/album949/sounddesign1_trax.gif">
                                                            ...
                                                            <td bgcolor="#c0c0c0">
                                                                ...
                                                                <p style="margin-left: 10px;"><span style="font-weight: bold;">Trax used in this composition:<br>
                                                                    ...
                                                                    A Day In The Park<br> <img vspace="0" hspace="0" border="0" align="bottom"
                                                                        ...
                                                                        alt=""> Nature Nightlife<br> <img vspace="0" hspace="0" border="0" align="bottom"
                                                                        src="{{ url('/') }}/c_images/album2304/trax_bullet_green.gif"
                                                                        alt=""> Furni Sounds 1<span style="font-weight: bold;"></span><br><br>Listen now<span
                                                                        style="font-weight: bold;"> <a
                                                                            href="{{ url('/') }}/c_images/album2354/traxexample11_sounddesign.mp3"><img
