                                                            ...
                                                            <td colspan="2">
                                                                <p align="center">
                                                                    <img vspace="15" hspace="4" border="0" align="middle"
                                                                        src="{{ url('/') }}/c_images/album1895/tm_room_romantic_2.gif" alt="">
                                                                </p>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td valign="top" rowspan="2">
                                                                <p style="margin-left: 5px; margin-right: 5px;"><img vspace="5" hspace="5" border="0" align="left"
                                                                        src="{{ url('/') }}/c_images/album1395/dj_ambient.gif" alt="">The idea of Ambient music was born in
                                                            ...
                                                            <td bgcolor="#c0c0c0">
                                                                <br>
                                                                <p align="center"><a href="{{ url('/') }}/c_images/album949/chillout_trax.gif"><img
                                                                            src="{{ url('/') }}/c_images/album1390/chillout_200x131.gif" alt=""><br></a></p>
                                                                <p align="center"><a href="{{ url('/') }}/c_images/album949/chillout_trax.gif">Click
                                                            ...
                                                            <td bgcolor="#c0c0c0"><span style="font-weight: bold;"><br></span>
                                                                ...
                                                                <p style="margin-left: 10px;"><span style="font-weight: bold;">Trax used in this composition:</span><br>
                                                                    ...
                                                                    Sunset Adventures<br> <img vspace="0" hspace="0" border="0" align="bottom"
                                                                        src="{{ url('/') }}/c_images/album2304/trax_bullet_blue.gif" alt=""> Electronica<br> <img
                                                                        vspace="0" hspace="0" border="0" align="bottom"
                                                                        src="{{ url('/') }}/c_images/album2304/trax_bullet_green.gif" alt=""> Ambiences<br>
                                                                </p>
                                                                <p style="margin-left: 10px;"><br> Listen now <a
                                                                        href="{{ url('/') }}/c_images/album2354/traxexample6_chillout.mp3"><img vspace="0" hspace="0"
