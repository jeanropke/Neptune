                        ...
                        <div class="v3box-content">
                            <div class="v3box-body">
                                ...
                                <table width="100%" border="0">
                                    <tbody>
                                        <tr>
                                            <td> <img vspace="0" hspace="0" border="0" src="{{ url('/') }}/c_images/album1379/nav.gif" alt=""></td>
                                        ...
                                        <tr>
                                            <td><img vspace="0" hspace="0" border="0" align="bottom" src="{{ url('/') }}/c_images/album1379/public.gif"
                                                    alt=""><br>
                                            </td>
                                        ...
                                        <tr>
                                            <td> <img vspace="0" hspace="0" border="0" src="{{ url('/') }}/c_images/album1379/private.gif" alt=""></td>
