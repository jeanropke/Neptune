            ...
            <tr>
                ...
                <td valign="top" style="width: 539px;" class="habboPage-col rightmost">
                    ...
                    <div class="v3box blue">
                        <div class="v3box-top">
                            <h3>{{ cms_config('hotel.name.short') }} Home Pages</h3>
                        </div>
                        <div class="v3box-content">
                            <div class="v3box-body">
                                ...
                                <table width="100%" border="0" id="table1">
                                    <tbody>
                                        <tr>
                                            <td valign="top"><img
                                                    src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/inst_Introduction.gif"
                                                    alt="The image “http://images.habbohotel.com/c_images/album1357/inst_Introduction.gif” cannot be displayed, because it contains errors.">
                                            </td>
                                            <td valign="top"><b>Introduction</b>
                                                <p>To get to your {{ cms_config('hotel.name.short') }} Home simply click the 'view my {{ cms_config('hotel.name.short') }} Home' link on
                                                    your {{ cms_config('hotel.name.short') }} toolbar.</p>
                                                ...
                                                <p>All the things on your Home page are movable, to move an element
                                                    simply click on it when it edit mode and drag it about!</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table width="100%" border="0" id="table2">
                                    <tbody>
                                        <tr>
                                            <td valign="top">
                                                <img src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/inst_inventory_purchasing.gif"
                                                    alt="The image “http://images.habbohotel.com/c_images/album1357/inst_inventory_purchasing.gif” cannot be displayed, because it contains errors.">
                                            </td>
                                            <td valign="top"><b>Your Inventory</b>
                                                <p>Once in editing mode you can
                                                ...
                                                <p>You get some free things to start, however extra stuff costs {{ cms_config('hotel.name.short') }}
                                                    Credits.</p>
                                                <p><a href="/web/20071012014336/http://habbo.com/credits/" target="_self">Tell me about {{ cms_config('hotel.name.short') }} Credits</a>
                                                </p>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <table width="100%" border="0" id="table3">
                                    <tbody>
                                        <tr>
                                            <td valign="top"> <img
                                                    src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/inst_Stickie_Notes.gif"
                                                    alt="The image “http://images.habbohotel.com/c_images/album1357/inst_Stickie_Notes.gif” cannot be displayed, because it contains errors.">
                                            </td>
                                            <td valign="top"><b>Using notes</b>
                                                <p>To add a note to
                                ...
                                <table width="100%" border="0" id="table4">
                                    <tbody>
                                        <tr>
                                            <td valign="top"> <img
                                                    src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/inst_Stickers.gif"
                                                    alt="The image “http://images.habbohotel.com/c_images/album1357/inst_Stickers.gif” cannot be displayed, because it contains errors.">
                                            </td>
                                            <td valign="top"><b>Stickers</b>
                                                <p>To add a Sticker to you {{ cms_config('hotel.name.short') }} Home
                                ...
                                <table width="100%" border="0" id="table5">
                                    <tbody>
                                        <tr>
                                            <td valign="top"><img
                                                    src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/Habbo_Homes_Instructions_Using_Habbo_Homes_Widgets.gif"
                                                    alt=""><br> </td>
                                            <td valign="top"><b>Widgets</b>
                                                <p>Widgets are content boxes that give
                                                ...
                                                <p>Click the Widgets button to be able to place them on your page. Once
                                                    ...
                                                    widget or remove it from your page and put it back in your Inventory.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table width="100%" border="0" id="table6">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <img src="https://web.archive.org/web/20071012014336im_/http://images.habbohotel.com/c_images/album1357/inst_backgrounds.gif"
                                                    alt="The image “http://images.habbohotel.com/c_images/album1357/inst_backgrounds.gif” cannot be displayed, because it contains errors.">
                                            </td>
                                            <td><span style="font-weight: bold;">Backgrounds</span>
                                                <p>To add a background click the Backgrounds button to
                                                    ...
                                                    background will enter into your Inventory.</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
