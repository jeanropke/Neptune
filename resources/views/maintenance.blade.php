...
<head>
    ...
    <title>{{ cms_config('hotel.name.short') }} Hotel ~ Maintenance break</title>
    <style type="text/css">
...
<body>
    <table width="10" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
    <tbody>
    <tr>
        <td>
                ...
                <tr>
                    ...
                    <td width="732" valign="top" bgcolor="#47839D">
                        <table width="100%" border="0" cellspacing="0" cellpadding="10">
                            <tbody>
                            <tr>
                                <td height="314" valign="middle"><p class="style1"><span class="style2">SORRY!!! MAINTENANCE BREAK!</span><br>
                                        In order to ensure an uninterrupted service environment, {{ cms_config('hotel.name.short') }} is carrying out
                                        maintenance operations on its online services, including some changes, updates
                                        and service functions! We aim to minimize any disturbances resulting from the
                                        maintenance. Please check back here soon!</p>

                                    <p class="style1">We look forward to your next check-in at {{ cms_config('hotel.name.short') }}! </p>

                                    <p class="style1">&nbsp;</p>

                                    <p class="style1"><span class="style2" style="text-transform: uppercase">WHAT IS {{ cms_config('hotel.name.short') }}?</span><br>
                                        {{ cms_config('hotel.name.short') }} is a FREE virtual community for teens where you can hang out with your
                                        current friends, meet new people, and create and design your very own personal
                                ...
                                <td bgcolor="#0A4362">
                                    <div align="center">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            ...
                                            <tr>
                                                <td valign="middle">
                                                    <div align="center"><span class="style3">© 2007 Sulake Corporation Ltd. HABBO is a registered trademark of Sulake Corporation Oy in the European Union, the USA, Japan, the People's Republic of China and various other jurisdictions. All rights reserved.</span>
                                                    </div>
                                                </td>
                                            </tr>
                                            </tbody>
