...
<body bgcolor="#292929">
    {{--<object type="application/x-shockwave-flash"
        data="{{ cms_config('site.web.url') }}/flash/habbowood/movie_player_skin.swf?figuredata_url={{ cms_config('site.web.url') }}/xml/figure_data_xml_hc.xml
        &movie_data_url={{ url('/') }}/habbomovies/movie_xml_data/{{ $movie->id }}&localization_url={{ cms_config('site.web.url') }}/xml/habbowood_locale.xml&shoot_movie_url=/private/openeditor
    ...
    <script>
        var swfobj = new SWFObject("{{ cms_config('site.web.url') }}/flash/habbowood/movie_player_skin.swf", "movie_player_skin", "536", "360", "7");
        ...
        swfobj.addVariable("localization_url", "{{ cms_config('site.web.url') }}/xml/habbowood_locale.xml");
