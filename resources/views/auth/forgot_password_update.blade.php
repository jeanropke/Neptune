    ...
    <div id="process-wrapper">
        ...
        <div id="outer">
            <div id="outer-content">
                <div id="accountlist" class="processbox grey">
                    ...
                    <div class="content-top">
                        <div class="content">
                            ...
                            <img vspace="0" hspace="10" border="0" align="right" src="{{ cms_config('site.c_images.url') }}/album1358/frank_thumbup.gif" alt="">
                ...
                <div id="footer">
                    <div id="footer-top">
                        <div id="footer-content">© {{ date('Y') }} Sulake Corporation Ltd. HABBO is a registered trademark of Sulake Corporation Oy in the European Union, the USA,
                            Japan, the
