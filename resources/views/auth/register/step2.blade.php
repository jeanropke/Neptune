            ...
            <div id="process-header-body">
                <div id="process-header-content">
                    ...
                    <div id="steps">
                        ...
                        <img src="{{ url('/') }}/web/images/process/step2_on.gif" alt="2" width="30" height="26" />
            ...
            <div id="outer-content">
                        ...
                        <div class="content">
                            <div class="content-column1">
                              ...
                              <input type="button" value="&gt;" id="change-direction-body-next" class="direction-change-btn"-->
                                ...
                                <div class="frank"><img src="{{ url('/') }}/web/images/register/register3.gif" alt="" width="245" height="191" /></div>
                            </div>
                                                ...
                                                <form method="post" action="{{ url('/') }}/register/step/3" id="stepform" autocomplete="off">
                                                    ...
                                                    <p> <b>Choose your username:</b><br>
                                                        ...
                                                        <p> <b>NOW, CHOOSE YOUR PASSWORD:</b><br>
                                                            Your <b>password</b> must be at least ten characters long. Your <b>password</b> can contain both <b>uppercase letters</b> and <b>numbers</b>. </p>
                ...
                <script type="text/javascript" language="JavaScript">
                    ...
                    function showUsernameStatus(req, jsonObj) {
                        var msgNode = $("unMsg");
                        if (!msgNode) {
                            var node = Builder.node("div", { id:"unMsg", className:"field-status-error" }, [
                                Builder.node("b", "Name check: "),
                                Builder.node("span", { id:"unMsg-content" })
                            ]);
