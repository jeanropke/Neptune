                                        ...
                                        <div class="content-white-body">
                                            <div>
                                                <form method="post" action="{{ url('/') }}/register/done" id="stepform" autocomplete="off">
                                                    ...
                                                    <div id="terms"> By Checking the checkbox bellow, I prove that I know, that Habbo retros are illegal and have smaller security than real Habbo. Also I don't work at Sulake nor any related company.</span> </div>
