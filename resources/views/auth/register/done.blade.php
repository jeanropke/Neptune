            ...
            <div id="process-header-body">
                <div id="process-header-content">
                    ...
                    <div id="steps">
                        ...
                        <img src="{{ url('/') }}/web/images/process/step_right.gif" alt="" width="20" height="26" />
                        <img src="{{ url('/') }}/web/images/process/step5_on.gif" alt="5" width="30" height="26" /> </div>
                </div>
            </div>
        </div>
        <div id="outer">
                    ...
                    <div class="content-top">
                        <div class="content">
                            <div class="content-column1">
                                ...
                                <div class="frank"><img src="{{ url('/') }}/web/images/register/register8.gif" alt="" width="245" height="196" /></div>
                            </div>
