                                    ...
                                    <div class="v3box yellow">
                                        ...
                                        <div class="v3box-content">
                                            <div class="v3box-body">
                                                Here are the most important rules you must follow inside Habbo Hotel. Our <a target="_self"
                                                    href="{{ url('/') }}/footer_pages/terms_and_conditions">Terms
                                                    and Conditions</a> contains the full list of rules - please read those
                                                if you are unsure about how to act. If you break the Habbo Way or the <a target="_self"
                                                    href="{{ url('/') }}/footer_pages/terms_and_conditions">Terms
                                                ...
                                                <ul>
                                                    <li>Ask for or give out passwords, email addresses or other personal
                                                        information</li><img width="41" height="78" align="right" src="{{ url('/') }}/c_images/content/thumb_down.gif"
                                                        alt="">
                                                ...
                                                <ul>
                                                    <li><img width="41" height="78" align="right" src="{{ url('/') }}/c_images/content/thumb_up.gif" alt="">Have
                                                        fun!</li>
