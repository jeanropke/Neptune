    ...
    <table cellpadding="0" cellspacing="8" width="100%" id="tablewrap">
        <tr>
            <td width="22%" valign="top" id="leftblock">
                <div>
                    @include('housekeeping.moderation.include.menu', ['submenu' => 'publicroom.listing'])
                </div>
            </td>
            <td width="78%" valign="top" id="rightblock">
                <div>
                                ...
                                <tr class="{{ $loop->index % 2 == 0 ? 'even' : 'odd' }}">
                                    ...
                                    <td class="tablerow2" align="center">
                                        <a href="{{ route('housekeeping.editor.publicroom.edit', $room->id) }}">
                                            <img src=" {{ cms_config('site.web.url') }}/housekeeping/images/edit.gif" alt="Edit publicroom">
                                        </a>
                                    </td>
                                    <td class="tablerow2" align="center">
                    ...
                    <div style="text-align: center; vertical-align: middle;">{!! $rooms->withQueryString()->links('includes.housekeeping.pagination') !!}</div>
                </div>
                <!-- / RIGHT CONTENT BLOCK -->
            </td>
        </tr>
