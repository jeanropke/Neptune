        ...
        <tr>
            ...
            <td width="78%" valign="top" id="rightblock">
                <div>
                    ...
                    <form action="{{ route('housekeeping.site.news_edit.save', $article->id) }}" method="post" name="theAdminForm" id="theAdminForm">
                        {{ csrf_field() }}
                        <div class="tableborder">
                            ...
                            <table width="100%" cellspacing="0" cellpadding="5" align="center" border="0">
                                    ...
                                    <td class="tablerow2" width="60%" valign="middle">
                                        ...
                                        <select name="topstory" onchange="changePreviewImage()" id="ts_image" class="textinput" style="margin-top: 5px;" size="1">
                                            @foreach ($ts_images as $ts_img)
                                                <option value="{{ url('/') }}/{{ str_replace('\\', '/', $ts_img) }}" @if (url('/') . '/' . str_replace('\\', '/', $ts_img) == $article->image) selected="selected" @endif>
                                ...
                                <tr>
                                    ...
                                    <td class="tablerow2" width="60%" valign="middle">
                                        <input type="text" name="author_override" value="{{ old('author_override') ?? $article->author_override }}" size="30" class="textinput">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="tablerow2" width="60%" valign="middle">
                                        <input type="datetime-local" name="publish_date" value="{{ old('publish_date') ?? $article->publish_date }}" size="30" class="textinput">
                                    </td>
                                </tr>
