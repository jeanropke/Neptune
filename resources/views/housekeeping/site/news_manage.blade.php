                    ...
                    <form action="index.php?p=news_manage&do=save" method="post" name="theAdminForm" id="theAdminForm">
                        <div class="tableborder">
                            ...
                            <table cellpadding="4" cellspacing="0" width="100%">
                                ...
                                @forelse($articles as $article)
                                    <tr>
                                        ...
                                        <td class="tablerow2" align="center">
                                            <a href="{{ route('housekeeping.site.news_edit', $article->id) }}">
                            ...
                            <div class="tablefooter" align="center">
                                <div class="fauxbutton-wrapper"><span class="fauxbutton"><a href="{{ route('housekeeping.site.news_compose') }}">Compose New News Item</a></span>
                                </div>
                            </div>
                        </div>
                    </form>
