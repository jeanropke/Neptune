    ...
    <table cellpadding="0" cellspacing="8" width="100%" id="tablewrap">
        <tr>
            <td width="22%" valign="top" id="leftblock">
                <div>
                    @include('housekeeping.site.include.menu', ['submenu' => 'news_compose'])
                </div>
            </td>
            <td width="78%" valign="top" id="rightblock">
                <div>
                    ...
                    @endif
                    <form action="{{ route('housekeeping.site.news_compose') }}" method="post" name="theAdminForm" id="theAdminForm" autocomplete="off">
                        {{ csrf_field() }}
