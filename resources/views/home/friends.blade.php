<div class="movable widget FriendsWidget" id="widget-{{ $item->id}}" style=" left: 387px; top: 6px; z-index: 5;">
    <div class="w_skin_goldenskin">
        <div class="widget-corner" id="widget-{{ $item->id}}-handle">
            <div class="widget-headline">
                <h3><span class="header-left">&nbsp;</span><span class="header-middle">MY FRIENDS</span><span
                ...
                <div id="slider">
                    <div id="slider-bar">
                        <div style="left: 0px; position: relative;" class="selected" id="slider-handle"><img
                                src="{{ url('/') }}/web/images/myhabbo/slider/slider_scaler.gif"></div>
                    </div>
                </div>
