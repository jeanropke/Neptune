        ...
        <div class="widget-corner" id="widget-{{ $item->id }}-handle">
            <div class="widget-headline">
                <h3>
                    ...
                    <span class="header-middle">&nbsp;My Friends (<span id="avatar-list-size">{{ $user->getFriends()->count() }}</span>)&nbsp;</span>
                            ...
                            @forelse($friends->take(20)->get() as $friend)
                                ...
                                <li id="avatar-list-{{ $item->id }}-{{ $friend->id }}" title="{{ $friend->username }}">
                                    <div class="avatar-list-open">
                                        <a href="#" id="avatar-list-open-link-{{ $item->id }}-{{ $friend->id }}" class="avatar-list-open-link"></a>
                                    </div>
