                ...
                <div class="v3box orange">
                    ...
                    <div class="v3box-content">
                        <div class="v3box-body">
                            ...
                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt=""> New widget skins

                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt=""> New Backgrounds

                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt=""> No ads!<br><br>
                ...
                <div class="v3box orange">
                    ...
                    <div class="v3box-content">
                        <div class="v3box-body">
                            ...
                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt="">  Huge Friends List

                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt=""> :chooser command

                            <br><img vspace="0" hspace="0" border="0" align="absmiddle" src="{{ cms_config('site.web.url') }}/images/club/miniHCbadge.gif" alt=""> :furni command<br><br><a href="{{ url('/') }}/club/benefits/extras" target="_self">Find out more &gt;&gt;</a><br>
                            <div class="clear"></div>
                        </div>
                    </div>
                    <div class="v3box-bottom"><div></div></div>
                        ...
                        <div class="content-white-body">
                            ...
                            <div class="content-white-content">
                                <object width="521" height="320" align="middle" id="goth" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000">
                                    ...
                                    <embed width="521" height="320" align="middle" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" allowscriptaccess="sameDomain" name="Gothicpromo_292x250" bgcolor="#ffffff" quality="low" src="{{ cms_config('site.web.url') }}/images/club/HC_megashow1.swf">
                                </object>
                            </div>
                            <div class="clear"></div>
                        </div>
                ...
                <div class="v3box orange">
                    ...
                    <div class="v3box-content">
                        <div class="v3box-body">
                            ...
                            <img vspace="10" hspace="10" border="0" align="left" src="{{ cms_config('site.web.url') }}/images/club/piccolo_happy.gif" alt="">
                            <br><br>
