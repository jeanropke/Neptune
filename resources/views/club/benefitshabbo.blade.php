                        ...
                        <div class="content-white">
                            <div class="content-white-body">
                                ...
                                <div class="content-white-content">
                                    <img src="{{ cms_config('site.web.url') }}/images/club/HC_subpage_habbo.gif" alt=""><br><br><span style="font-weight: bold;">Extra
                                        Clothes</span><br>Fashionable outfits for your {{ cms_config('hotel.name.short') }}.<br><br><span style="font-weight: bold;">Different
                                        hair</span><br>Existing hair styles in different colours, and all new styles to get you noticed in the Hotel!<br><br><span
                                        style="font-weight: bold;">Club badge</span><br>A nice shiny badge to show that you're a member of the coolest club in all of
                                    {{ cms_config('hotel.name.short') }}.<br><br><span style="font-weight: bold;">New dances</span><br>Party in style with these dances, you'll tear
                                    up the dance floor!
                                </div>
                                <div class="clear"></div>
                            </div>
