@extends('layouts.master', ['menuId' => '3', 'submenuId' => '16', 'headline' => true])
                ...
                <div class="v3box orange">
                    ...
                    <div class="v3box-content">
                        <div class="v3box-body">
                            ...
                            <br><br>Available only to {{ cms_config('hotel.name.short') }} Club members - the Blue Solarium. <a target="_self" href="{{ url('/') }}/club/join">Join {{ cms_config('hotel.name.short') }} Club now</a> for your chance to buy it.<br>
                            <div class="clear"></div>
                        </div>
                    </div>
                ...
                <div class="nobox">
                    ...
                    <div class="nobox-content">
                        ...
                        <div class="v2box brown darkest">
                            <div class="headline"><h3 style="text-transform: uppercase">JOIN {{ cms_config('hotel.name.short') }} CLUB!</h3></div>
