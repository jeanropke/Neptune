...
var preview_function = function(e) {
	...
	new Ajax.Updater('new-post-preview-container', habboReqPath + '/discussions/actions/previewpost', { method:"post", parameters:params,
		onComplete:function(req, json) {
...
var previewtopic_function = function() {
	...
	new Ajax.Updater('new-topic-preview-container', habboReqPath + '/discussions/actions/previewtopic', { method:"post", parameters:params,
		onComplete:function(req, json) {
			...
			Event.observe("save-post-message", "click", function(e) {
                ...
                new Ajax.Request(habboReqPath + '/discussions/actions/savetopic', { method:"post", parameters:params,
						onComplete:function(req, json) {
                            var spamMessage = document.getElementById('spam-message').value;
							if (json && json.spam == "true") {
...
var delete_function = function(postId) {
    ...
    new Ajax.Updater('group-postlist-container', habboReqPath + '/discussions/actions/deletepost', { method:"post", parameters:params,
        onComplete:function(req, json) {
            req.responseText.evalScripts();
