...
GroupsWidget.prototype = {
	...
	showGroupDetails : function(e) {
		...
		var self = this;
		new Ajax.Request(habboReqPath + "/myhabbo/groups/groupinfo", { method:"post", parameters:"ownerId="+encodeURIComponent(this.ownerId)+"&groupId="+encodeURIComponent(this.groupId), onComplete:function(req, json) {
				self.infoEl.innerHTML = req.responseText;
	...
	refreshGroupList : function() {
		...
		var self = this;
		new Ajax.Updater(this.containerEl, habboReqPath + "/myhabbo/groups/grouplist", { method:"post",
...
ProfileWidget.prototype = {
    ...
    handleAddFriend : function(e) {
		...
		if (this.loggedInAccountId) {
			Event.stop(e);
			this.dialog = showConfirmDialog(this.options.messageText, { okHandler : this.doSendFriendRequest.bind(this),
