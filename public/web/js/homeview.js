...
var Discussions = {
    ...
    openTopicSettings: function() {
        ...
        Dialog.appendDialogBody(C, '<p style="text-align:center"><img src="' + habboStaticFilePath + '/images/progress_habbos.gif" alt="" width="102" height="67" /></p><div style="clear"></div>', true);
        Dialog.moveDialogToCenter(C);
        Overlay.show();
...
var FriendsWidget = Class.create({
    ...
    showAccountDetails: function(A) {
        ...
        new Ajax.Request(habboReqPath + "/myhabbo/avatarlist/avatarinfo", {
            method: "post",
            parameters: { ownerAccountId: encodeURIComponent(this.ownerId), anAccountId: encodeURIComponent(this.showId), _token: _token },
            onComplete: function(E, D) {
    ...
    _processSearch: function(F) {
        ...
        new Ajax.Updater("avatarlist-content", habboReqPath + this.options.searchUrl, {
            method: "post",
            parameters: "pageNumber=" + encodeURIComponent(D) + "&searchString=" + encodeURIComponent(this.searchString) + "&widgetId=" + this.widgetId + this.options.ownerParameter + this.ownerId + "&_token=" + _token
        })
    }
});
...
GuestbookWidget.prototype = {
    initialize: function(F, E, D) {
            ...
            Event.observe("guestbook-form-preview", "click", function(G) {
                ...
                if ($F("guestbook-message").length > 0) {
                    ...
                    new Ajax.Updater($("guestbook-preview-tab"), habboReqPath + "/myhabbo/guestbook/preview", {
                        method: "post",
                        parameters: Form.serialize($("guestbook-form")) + "&widgetId=" + encodeURIComponent(this.widgetId) + "&_token="+_token,
                        evalScripts: true,
                        onComplete: function() {
        ...
        console.log('monitorEventListener');
    },
    ...
    monitorScrollPosition: function() {
        console.log('monitorScrollPosition');
    ...
    doRemoveEntry: function(A) {
        new Ajax.Request(habboReqPath + "/myhabbo/guestbook/remove", {
            parameters: { entryId: encodeURIComponent(A), widgetId: encodeURIComponent(this.widgetId), _token: _token },
...
RatingObserver.prototype = {
    ...
    handleEvent: function(A) {
        ...
        new Ajax.Updater(this.commonAjaxParams.elementToUpdate, habboReqPath + this.urlToCall + "?_token="+_token, {
            method: "post",
            parameters: C,
            evalScripts: false,
            insertion: "bottom",
...
RatingWidget.prototype = {
    initialize: function(A, C) {
        this.idParams = "widgetId=" + A + "&ownerId=" + C;
...
GroupsWidget.prototype = {
    ...
    showGroupDetails: function(C) {
        ...
        new Ajax.Request(habboReqPath + "/myhabbo/groups/groupinfo", {
            method: "post",
            parameters: { ownerId: encodeURIComponent(this.ownerId), groupId: encodeURIComponent(this.groupId), _token: _token},
            onComplete: function(E, D) {
                this.infoEl.innerHTML = E.responseText;
...
TagWidgetPartial.prototype = {
    ...
    addAvatarTag: function(A, C) {
        ...
        new Ajax.Request(habboReqPath + "/myhabbo/tag/add", {
            parameters: {accountId: C, tagName: encodeURIComponent(A), _token: _token},
    ...
    addGroupTag: function(C, A) {
        ...
        new Ajax.Request(habboReqPath + "/myhabbo/tag/addgrouptag", {
            parameters: { groupId: A, tagName: encodeURIComponent(C), _token: _token},
            onSuccess: function(E) {
                var D = E.responseText;
                if (D == "valid" && $("profile-tags-status-field")) {
...
ProfileWidget.prototype = {
    ...
    handleAddFriend: function(A) {
        ...
        if (this.loggedInAccountId) {
            Event.stop(A);
			var dialog = createDialog("subscription_dialog", "Send friend request", 9001, 0, -1000, closeSubscription);
			...
			showOverlay();
			new Ajax.Request("/myhabbo/friends/request",{
				method: "post",
				parameters: {
    ...
    doSendFriendRequest: function() {
        ...
        new Ajax.Request(habboReqPath + "/myhabbo/friends/add", {
            parameters: { accountId: encodeURIComponent(this.accountId), _token: _token },
            onSuccess: function() {
...
var BadgesWidget = Class.create({
    ...
    _processSearch: function(F) {
        ...
        new Ajax.Updater(this.containerElement, habboReqPath + this.options.searchUrl, {
            method: "post",
            parameters: { pageNumber: encodeURIComponent(D), widgetId: this.widgetId, '_mypage.requested.account':  this.ownerId, _token: _token  },
