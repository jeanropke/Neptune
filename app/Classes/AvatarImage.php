...
define("PATH_RESOURCE",    resource_path() . "/habbo-imaging/figure/");
class AvatarImage
{
    ...
    function __construct($figure, $direction, $headDirection, $action, $gesture, $frame, $isHeadOnly, $scale)
    {
        ...
        $this->settings = array(
            "figuredata"        => $this->getJSON("./figuredata.json"),
            "hh_people"         => $this->getJSON("./hh_people/regpoints.json"),
            "hh_people_small"   => $this->getJSON("./hh_people_small/regpoints.json"),
            "partsets"          => $this->getJSON("./partsets.json"),
            "draworder"         => $this->getJSON("./draworder.json"),
            "offset"            => array()
        );
