...
class PhotoRenderer
{
    ...
    public function createImage($photoData)
    {
        ...
        if ($this->option == 'SEPIA') {
            $palettes = [
                0xFF010100, 0xFF681F10, 0xFF691F10, 0xFF702513, 0xFF692010, 0xFF88381C, 0xFF903E1F, 0xFFA85229,
                0xFFB0582C, 0xFFC86B36, 0xFFD07139, 0xFFE78543, 0xFFE88543, 0xFFF08B46, 0xFFFEA352, 0xFFFEB75C,
                0xFFFED069, 0xFFFEDD6F, 0xFFFF9E4F, 0xFFFFA452, 0xFFFFB85C, 0xFFFFBE5F, 0xFFFFD169, 0xFFFFD76C,
                0xFFFFDE6F
            ];
